        ...
        <>
            <Stack>
                ...
                <Center>
                    ...
                    >
                        <Heading textStyle={{base: "5xl", md: "6xl", xl: "7xl"}} marginBottom="1rem">Login</Heading>
                        <Heading fontWeight="normal" background="whiteAlpha.300" as="h4">Step back into the driver’s seat and enjoy the freedom of worry-free travel.</Heading>
                    </Box>
                </Center>
                <Center>
                    <Box marginTop={{base: "1rem",sm: "2rem", md: "3rem"}} maxW="90%" minW={{base: "90vw", sm: "90vw", md: "70vw", lg: "50vw",xl: "35vw"}}>
                        <Fieldset.Root size="lg">
                            <Text>Log in and pick up right where you left off on your journey.</Text>
                            ...
                            <Stack marginBottom="2rem">
                                ...
                                <Center>
                                    <Box>
                                        <Stack direction="row">
                                            <Center>
                                                <Text textStyle="sm" color="blackAlpha.700" marginRight="1rem">If you don't have an account</Text>
                                                <Link href="/register">
                                                    <Button size="sm" w="4.5rem" variant="surface">Register</Button>
                                                </Link>
                                            </Center>
                                        </Stack>
                                    </Box>
